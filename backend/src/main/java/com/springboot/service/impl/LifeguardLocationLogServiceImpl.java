 ...
 */
@Service
public class LifeguardLocationLogServiceImpl
        extends ServiceImpl<LifeguardLocationLogMapper, LifeguardLocationLog>
    ...
    @Override
    public QueryWrapper<LifeguardLocationLog> getQueryWrapper(
        ...
        queryWrapper.eq(
                lifeguardLocationLogQueryRequest.getId() != null,
                "id",
                lifeguardLocationLogQueryRequest.getId());
        queryWrapper.eq(
                lifeguardLocationLogQueryRequest.getLifeguardId() != null,
                "lifeguard_id",
                lifeguardLocationLogQueryRequest.getLifeguardId());
        queryWrapper.eq(
                lifeguardLocationLogQueryRequest.getVenueId() != null,
                "venue_id",
                lifeguardLocationLogQueryRequest.getVenueId());
        queryWrapper.eq(
                lifeguardLocationLogQueryRequest.getInFence() != null,
                "in_fence",
                lifeguardLocationLogQueryRequest.getInFence());
        queryWrapper.eq(
                StringUtils.isNotBlank(lifeguardLocationLogQueryRequest.getReportSource()),
                "report_source",
                lifeguardLocationLogQueryRequest.getReportSource());
    ...
    @Override
    public LifeguardLocationLogVO getLifeguardLocationLogVO(
    ...
    @Override
    public List<LifeguardLocationLogVO> getLifeguardLocationLogVO(
            List<LifeguardLocationLog> lifeguardLocationLogList) {
        if (CollUtil.isEmpty(lifeguardLocationLogList)) {
            return new ArrayList<>();
        }
        return lifeguardLocationLogList.stream()
                .map(this::getLifeguardLocationLogVO)
    ...
    public boolean reportLocation(LifeguardLocationLog lifeguardLocationLog) {
        ...
        lifeguardLocationLog.setIn_fence(
                lifeguardLocationLog.getIn_fence() == null
                        ? 1
                        : lifeguardLocationLog.getIn_fence());
        lifeguardLocationLog.setReport_source(
                StringUtils.defaultIfBlank(lifeguardLocationLog.getReport_source(), "APP"));
        lifeguardLocationLog.setReported_at(
                lifeguardLocationLog.getReported_at() == null
                        ? new Date()
                        : lifeguardLocationLog.getReported_at());
