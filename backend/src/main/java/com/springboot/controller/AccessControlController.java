...
public class AccessControlController {
    ...
    public BaseResponse<Boolean> assignUserRole(@RequestBody UserAssignRoleRequest request) {
        ...
        boolean updated =
                accessControlService.assignRoles(request.getUserId(), request.getRoleCodes());
    ...
    public BaseResponse<Boolean> updateRolePermission(
        ...
        boolean updated =
                accessControlService.updateRolePermissions(
                        request.getRoleCode(), request.getPermissions());
        return ResultUtils.success(updated);
    }
    ...
    public BaseResponse<Boolean> updateMyProfile(@RequestBody UserUpdateMyProfileRequest request) {
        ...
        if (request.getId() != null
                && !Objects.equals(request.getId(), authUserContext.getUserId())) {
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR, "仅允许修改当前登录账号");
        }
        boolean updated =
                accessControlService.updateMyProfile(
