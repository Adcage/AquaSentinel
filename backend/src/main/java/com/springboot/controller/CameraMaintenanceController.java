...
public class CameraMaintenanceController {
    ...
    @Resource private CameraMaintenanceLogService cameraMaintenanceLogService;
    ...
    public BaseResponse<Long> addCameraMaintenanceLog(
        ...
        CameraMaintenanceLog cameraMaintenanceLog =
                toCameraMaintenanceLog(cameraMaintenanceLogAddRequest);
        cameraMaintenanceLog.setMaintained_at(
                cameraMaintenanceLog.getMaintained_at() == null
                        ? new Date()
                        : cameraMaintenanceLog.getMaintained_at());
    ...
    @AuthCheck(mustRole = RoleConstant.VENUE_ADMIN)
    public BaseResponse<Long> addCameraMaintenanceLogByCamera(
            @PathVariable("cameraId") Long cameraId,
            @RequestBody CameraMaintenanceLogAddRequest request) {
        CameraMaintenanceLogAddRequest addRequest =
                request == null ? new CameraMaintenanceLogAddRequest() : request;
    ...
    @PostMapping("/delete")
    @AuthCheck(mustRole = RoleConstant.VENUE_ADMIN)
    public BaseResponse<Boolean> deleteCameraMaintenanceLog(
        ...
        CameraMaintenanceLog oldCameraMaintenanceLog =
                cameraMaintenanceLogService.getOne(queryWrapper);
    ...
    public BaseResponse<Boolean> updateCameraMaintenanceLog(
        ...
        if (cameraMaintenanceLogUpdateRequest == null
                || cameraMaintenanceLogUpdateRequest.getId() == null
                || cameraMaintenanceLogUpdateRequest.getId() <= 0) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        CameraMaintenanceLog cameraMaintenanceLog =
                toCameraMaintenanceLog(cameraMaintenanceLogUpdateRequest);
    ...
    public BaseResponse<Boolean> editCameraMaintenanceLog(
        ...
        if (cameraMaintenanceLogEditRequest == null
                || cameraMaintenanceLogEditRequest.getId() == null
        ...
        cameraMaintenanceLog.setMaintenance_type(
                cameraMaintenanceLogEditRequest.getMaintenanceType());
        cameraMaintenanceLog.setMaintenance_content(
                cameraMaintenanceLogEditRequest.getMaintenanceContent());
        ...
        cameraMaintenanceLog.setNext_maintenance_at(
                cameraMaintenanceLogEditRequest.getNextMaintenanceAt());
        cameraMaintenanceLogService.validCameraMaintenanceLog(cameraMaintenanceLog, false);
        boolean result = cameraMaintenanceLogService.updateById(cameraMaintenanceLog);
        ThrowUtils.throwIf(!result, ErrorCode.OPERATION_ERROR);
        return ResultUtils.success(true);
    ...
    public BaseResponse<CameraMaintenanceLogVO> getCameraMaintenanceLogVOById(long id) {
        ...
        return ResultUtils.success(
                cameraMaintenanceLogService.getCameraMaintenanceLogVO(response.getData()));
    }
    ...
    public BaseResponse<Page<CameraMaintenanceLog>> listCameraMaintenanceLogByPage(
        ...
        Page<CameraMaintenanceLog> cameraMaintenanceLogPage =
                cameraMaintenanceLogService.page(
                        new Page<>(current, size),
                        cameraMaintenanceLogService.getQueryWrapper(
                                cameraMaintenanceLogQueryRequest));
        return ResultUtils.success(cameraMaintenanceLogPage);
    }

    @GetMapping("/{cameraId}")
    public BaseResponse<Page<CameraMaintenanceLogVO>> listByCamera(
            @PathVariable("cameraId") Long cameraId,
    ...
    public BaseResponse<Page<CameraMaintenanceLogVO>> listCameraMaintenanceLogVOByPage(
            @RequestBody CameraMaintenanceLogQueryRequest cameraMaintenanceLogQueryRequest) {
        BaseResponse<Page<CameraMaintenanceLog>> response =
                listCameraMaintenanceLogByPage(cameraMaintenanceLogQueryRequest);
        Page<CameraMaintenanceLog> cameraMaintenanceLogPage = response.getData();
        Page<CameraMaintenanceLogVO> cameraMaintenanceLogVOPage =
                new Page<>(
                        cameraMaintenanceLogPage.getCurrent(),
                        cameraMaintenanceLogPage.getSize(),
                        cameraMaintenanceLogPage.getTotal());
        List<CameraMaintenanceLogVO> cameraMaintenanceLogVOList =
                cameraMaintenanceLogService.getCameraMaintenanceLogVO(
                        cameraMaintenanceLogPage.getRecords());
