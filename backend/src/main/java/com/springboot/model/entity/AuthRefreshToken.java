...
public class AuthRefreshToken implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getRefresh_token_hash() == null ? other.getRefresh_token_hash() == null : this.getRefresh_token_hash().equals(other.getRefresh_token_hash()))
            && (this.getDevice_id() == null ? other.getDevice_id() == null : this.getDevice_id().equals(other.getDevice_id()))
            && (this.getClient_type() == null ? other.getClient_type() == null : this.getClient_type().equals(other.getClient_type()))
            && (this.getClient_version() == null ? other.getClient_version() == null : this.getClient_version().equals(other.getClient_version()))
            && (this.getIp_address() == null ? other.getIp_address() == null : this.getIp_address().equals(other.getIp_address()))
            && (this.getExpires_at() == null ? other.getExpires_at() == null : this.getExpires_at().equals(other.getExpires_at()))
            && (this.getRevoked() == null ? other.getRevoked() == null : this.getRevoked().equals(other.getRevoked()))
            && (this.getRevoked_at() == null ? other.getRevoked_at() == null : this.getRevoked_at().equals(other.getRevoked_at()))
            && (this.getRevoke_reason() == null ? other.getRevoke_reason() == null : this.getRevoke_reason().equals(other.getRevoke_reason()))
            && (this.getLast_used_at() == null ? other.getLast_used_at() == null : this.getLast_used_at().equals(other.getLast_used_at()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getRefresh_token_hash() == null) ? 0 : getRefresh_token_hash().hashCode());
        ...
        result = prime * result + ((getClient_version() == null) ? 0 : getClient_version().hashCode());
        ...
        result = prime * result + ((getRevoke_reason() == null) ? 0 : getRevoke_reason().hashCode());
