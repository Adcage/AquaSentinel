...
public class AlertRecord implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getAlert_uid() == null ? other.getAlert_uid() == null : this.getAlert_uid().equals(other.getAlert_uid()))
            ...
            && (this.getAlert_type() == null ? other.getAlert_type() == null : this.getAlert_type().equals(other.getAlert_type()))
            && (this.getAlert_status() == null ? other.getAlert_status() == null : this.getAlert_status().equals(other.getAlert_status()))
            ...
            && (this.getDetection_result() == null ? other.getDetection_result() == null : this.getDetection_result().equals(other.getDetection_result()))
            && (this.getPushed_to_app() == null ? other.getPushed_to_app() == null : this.getPushed_to_app().equals(other.getPushed_to_app()))
            && (this.getPushed_to_pc() == null ? other.getPushed_to_pc() == null : this.getPushed_to_pc().equals(other.getPushed_to_pc()))
            && (this.getFirst_push_time() == null ? other.getFirst_push_time() == null : this.getFirst_push_time().equals(other.getFirst_push_time()))
            && (this.getResolved_time() == null ? other.getResolved_time() == null : this.getResolved_time().equals(other.getResolved_time()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDetection_result() == null) ? 0 : getDetection_result().hashCode());
        result = prime * result + ((getPushed_to_app() == null) ? 0 : getPushed_to_app().hashCode());
        result = prime * result + ((getPushed_to_pc() == null) ? 0 : getPushed_to_pc().hashCode());
        result = prime * result + ((getFirst_push_time() == null) ? 0 : getFirst_push_time().hashCode());
        result = prime * result + ((getResolved_time() == null) ? 0 : getResolved_time().hashCode());
