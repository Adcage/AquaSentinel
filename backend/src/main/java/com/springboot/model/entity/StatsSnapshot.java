...
public class StatsSnapshot implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getSnapshot_date() == null ? other.getSnapshot_date() == null : this.getSnapshot_date().equals(other.getSnapshot_date()))
            && (this.getSnapshot_hour() == null ? other.getSnapshot_hour() == null : this.getSnapshot_hour().equals(other.getSnapshot_hour()))
            && (this.getVenue_id() == null ? other.getVenue_id() == null : this.getVenue_id().equals(other.getVenue_id()))
            && (this.getMetric_type() == null ? other.getMetric_type() == null : this.getMetric_type().equals(other.getMetric_type()))
            && (this.getMetric_key() == null ? other.getMetric_key() == null : this.getMetric_key().equals(other.getMetric_key()))
            && (this.getMetric_value() == null ? other.getMetric_value() == null : this.getMetric_value().equals(other.getMetric_value()))
            && (this.getDimension_json() == null ? other.getDimension_json() == null : this.getDimension_json().equals(other.getDimension_json()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSnapshot_date() == null) ? 0 : getSnapshot_date().hashCode());
        result = prime * result + ((getSnapshot_hour() == null) ? 0 : getSnapshot_hour().hashCode());
        ...
        result = prime * result + ((getDimension_json() == null) ? 0 : getDimension_json().hashCode());
