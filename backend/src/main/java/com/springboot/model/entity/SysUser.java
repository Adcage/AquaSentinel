...
public class SysUser implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                ...
                && (this.getPassword_hash() == null
                        ? other.getPassword_hash() == null
                        : this.getPassword_hash().equals(other.getPassword_hash()))
                && (this.getDisplay_name() == null
                        ? other.getDisplay_name() == null
                        : this.getDisplay_name().equals(other.getDisplay_name()))
                && (this.getPhone() == null
                        ? other.getPhone() == null
                ...
                && (this.getFailed_login_count() == null
                        ? other.getFailed_login_count() == null
                        : this.getFailed_login_count().equals(other.getFailed_login_count()))
                && (this.getLock_until() == null
                        ? other.getLock_until() == null
                        : this.getLock_until().equals(other.getLock_until()))
                && (this.getForce_change_password() == null
                        ? other.getForce_change_password() == null
                        : this.getForce_change_password().equals(other.getForce_change_password()))
    ...
    public int hashCode() {
        ...
        result =
                prime * result + ((getPassword_hash() == null) ? 0 : getPassword_hash().hashCode());
        ...
        result =
                prime * result
                        + ((getFailed_login_count() == null)
                                ? 0
                                : getFailed_login_count().hashCode());
        result = prime * result + ((getLock_until() == null) ? 0 : getLock_until().hashCode());
        result =
                prime * result
                        + ((getForce_change_password() == null)
                                ? 0
                                : getForce_change_password().hashCode());
        result =
