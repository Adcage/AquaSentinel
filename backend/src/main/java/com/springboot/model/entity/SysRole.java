...
public class SysRole implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getPermission_json() == null ? other.getPermission_json() == null : this.getPermission_json().equals(other.getPermission_json()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPermission_json() == null) ? 0 : getPermission_json().hashCode());
