...
/** AI流任务表 @TableName ai_stream_task */
...
public class AiStreamTask implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                && (this.getTask_code() == null
                        ? other.getTask_code() == null
                        : this.getTask_code().equals(other.getTask_code()))
                ...
                && (this.getFrame_interval_ms() == null
                        ? other.getFrame_interval_ms() == null
                        : this.getFrame_interval_ms().equals(other.getFrame_interval_ms()))
                && (this.getCallback_url() == null
                        ? other.getCallback_url() == null
                        : this.getCallback_url().equals(other.getCallback_url()))
                && (this.getTask_status() == null
                        ? other.getTask_status() == null
                        : this.getTask_status().equals(other.getTask_status()))
                && (this.getStarted_at() == null
                        ? other.getStarted_at() == null
                        : this.getStarted_at().equals(other.getStarted_at()))
                && (this.getStopped_at() == null
                        ? other.getStopped_at() == null
                        : this.getStopped_at().equals(other.getStopped_at()))
                && (this.getLast_frame_at() == null
                        ? other.getLast_frame_at() == null
                        : this.getLast_frame_at().equals(other.getLast_frame_at()))
    ...
    public int hashCode() {
        ...
        result =
                prime * result
                        + ((getFrame_interval_ms() == null)
                                ? 0
                                : getFrame_interval_ms().hashCode());
        ...
        result =
                prime * result + ((getLast_frame_at() == null) ? 0 : getLast_frame_at().hashCode());
