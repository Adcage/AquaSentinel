...
public class AlertDisposal implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getAlert_id() == null ? other.getAlert_id() == null : this.getAlert_id().equals(other.getAlert_id()))
            && (this.getOperator_user_id() == null ? other.getOperator_user_id() == null : this.getOperator_user_id().equals(other.getOperator_user_id()))
            && (this.getOperator_role() == null ? other.getOperator_role() == null : this.getOperator_role().equals(other.getOperator_role()))
            ...
            && (this.getAction_time() == null ? other.getAction_time() == null : this.getAction_time().equals(other.getAction_time()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getOperator_user_id() == null) ? 0 : getOperator_user_id().hashCode());
        result = prime * result + ((getOperator_role() == null) ? 0 : getOperator_role().hashCode());
