...
public class LifeguardDutyLog implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getPlanned_return_at() == null ? other.getPlanned_return_at() == null : this.getPlanned_return_at().equals(other.getPlanned_return_at()))
            && (this.getActual_return_at() == null ? other.getActual_return_at() == null : this.getActual_return_at().equals(other.getActual_return_at()))
            && (this.getApproved_by() == null ? other.getApproved_by() == null : this.getApproved_by().equals(other.getApproved_by()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPlanned_return_at() == null) ? 0 : getPlanned_return_at().hashCode());
        result = prime * result + ((getActual_return_at() == null) ? 0 : getActual_return_at().hashCode());
