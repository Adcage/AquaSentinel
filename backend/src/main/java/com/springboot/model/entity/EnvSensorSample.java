...
public class EnvSensorSample implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getSensor_code() == null ? other.getSensor_code() == null : this.getSensor_code().equals(other.getSensor_code()))
            && (this.getWater_temperature() == null ? other.getWater_temperature() == null : this.getWater_temperature().equals(other.getWater_temperature()))
            && (this.getHumidity() == null ? other.getHumidity() == null : this.getHumidity().equals(other.getHumidity()))
            && (this.getQuality_flag() == null ? other.getQuality_flag() == null : this.getQuality_flag().equals(other.getQuality_flag()))
            && (this.getSample_time() == null ? other.getSample_time() == null : this.getSample_time().equals(other.getSample_time()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getWater_temperature() == null) ? 0 : getWater_temperature().hashCode());
