...
/** 监控事件表 @TableName monitoring_event */
...
public class MonitoringEvent implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                && (this.getEvent_uid() == null
                        ? other.getEvent_uid() == null
                        : this.getEvent_uid().equals(other.getEvent_uid()))
                && (this.getCamera_id() == null
                        ? other.getCamera_id() == null
                        : this.getCamera_id().equals(other.getCamera_id()))
                && (this.getTask_id() == null
                        ? other.getTask_id() == null
                        : this.getTask_id().equals(other.getTask_id()))
                && (this.getEvent_type() == null
                        ? other.getEvent_type() == null
                        : this.getEvent_type().equals(other.getEvent_type()))
                && (this.getRisk_level() == null
                        ? other.getRisk_level() == null
                        : this.getRisk_level().equals(other.getRisk_level()))
                && (this.getConfidence() == null
                        ? other.getConfidence() == null
                        : this.getConfidence().equals(other.getConfidence()))
                && (this.getTarget_id() == null
                        ? other.getTarget_id() == null
                        : this.getTarget_id().equals(other.getTarget_id()))
                && (this.getPool_head_count() == null
                        ? other.getPool_head_count() == null
                        : this.getPool_head_count().equals(other.getPool_head_count()))
                && (this.getBbox_json() == null
                        ? other.getBbox_json() == null
                        : this.getBbox_json().equals(other.getBbox_json()))
                && (this.getPosition_desc() == null
                        ? other.getPosition_desc() == null
                        : this.getPosition_desc().equals(other.getPosition_desc()))
                ...
                && (this.getEvent_time() == null
                        ? other.getEvent_time() == null
                        : this.getEvent_time().equals(other.getEvent_time()))
                && (this.getExt_json() == null
                        ? other.getExt_json() == null
                        : this.getExt_json().equals(other.getExt_json()))
    ...
    public int hashCode() {
        ...
        result =
                prime * result
                        + ((getPool_head_count() == null) ? 0 : getPool_head_count().hashCode());
        result = prime * result + ((getBbox_json() == null) ? 0 : getBbox_json().hashCode());
        result =
                prime * result + ((getPosition_desc() == null) ? 0 : getPosition_desc().hashCode());
        result =
                prime * result
