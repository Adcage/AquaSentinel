...
public class JwtAuthInterceptor implements HandlerInterceptor {
    ...
    public JwtAuthInterceptor(JwtTokenProvider jwtTokenProvider, AccessControlService accessControlService) {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
        ...
        authUserContext.setPermissionCodes(accessControlService.listPermissionsByRoleCodes(authUserContext.getRoleCodes()));
